...
namespace animalHairdresser
{
    public interface IClientBaseService
    {
        ...
        public Task<bool> ClientContainsAnimalsAsync(string connString, string name, Animals animal);
        public Task<Animals[]> SelectAnimalsFromClientAsync(string connString, string name);
        public Task DeleteAnimalAsync(string connString, string name, Animals animal);
        public Task AddAnimalToClientAsync(string connString, string name, Animals animal);
